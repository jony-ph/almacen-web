...
function updatePrivilegesTable(){
    ...
    privilegesList.forEach( pvg => {
        ...
        buttonUpdate.setAttribute('data-bs-target', '#update-privilege-modal');
        buttonUpdate.innerHTML = `Editar <i class="fa fa-edit"></i>`;
        buttonUpdate.onclick = function() {
            updatePrivilegeID = privilege_code;
            privilegePrivilegeUpdate.value = privilege;
            privilegeDescriptionUpdate.value = description;
        };
        ...
        buttonDelete.onclick = function() {
            deletePrivilege(privilege_code);
        };
...
function newPrivilege(e) {
    ...
    const privilegeData = new FormData(privilegeFormAdd);
    const url = 'API/privileges/add.php';

    const privilege = privilegeData.get('privilege-add');
    const description = privilegeData.get('description-privilege-add');
